  ...
  return (
    <div id="wd-dashboard">
      ...
      <div id="wd-dashboard-courses">
        ...
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/5678/Home" className="wd-dashboard-course-link">
            ...
            <div>
              ...
              <p className="wd-dashboard-course-title">Backend Development Essentials</p>
              <button>Go</button>
            </div>
          </Link>
        </div>
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/9101/Home" className="wd-dashboard-course-link">
            ...
            <div>
              ...
              <p className="wd-dashboard-course-title">Frontend Framework Mastery</p>
              <button>Go</button>
            </div>
          </Link>
        </div>
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/1123/Home" className="wd-dashboard-course-link">
            <img src="/images/python.png" width={200} />
            <div>
              <h5>CS1123 Python Programming</h5>
              <p className="wd-dashboard-course-title">Programming Foundations</p>
              <button>Go</button>
            </div>
          </Link>
        </div>
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/1415/Home" className="wd-dashboard-course-link">
        ...
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/1617/Home" className="wd-dashboard-course-link">
        ...
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/1819/Home" className="wd-dashboard-course-link">
        ...
        <div className="wd-dashboard-course">
          <Link to="/Kambaz/Courses/2021/Home" className="wd-dashboard-course-link">
